...
Demo final project. Tel-Ran.de GmbH Starta Institute (Germany), 2023-2024.

## Description

**Bank Service Application** - a backend-driven application that simulates core banking operations.

 - Developed a backend application simulating core banking operations with a focus on high security and performance.
 - Implemented key banking features, ensuring data integrity and security using Spring Security.
 - Deployed the application using Docker, optimizing for scalability and reliability.
 - Conducted thorough testing with JUnit to ensure code quality and system stability.
