...
INSERT INTO clients (id, client_status, taxCode, first_name, last_name, email, address, phone_number, manager_id)
VALUES ('b3a3a896-969c-11ee-b9d1-0242ac120002', 'ACTIVE', '123456789', 'Alice', 'Johnson', 'alice@email.com',
        '123 Main St', '123-456-7890', '6e42ea78-969c-11ee-b9d1-0242ac120002'),
       ('b9814aa2-969c-11ee-b9d1-0242ac120002', 'INACTIVE', '987654321', 'Bob', 'Smith', 'bob@email.com', '456 Oak St',
...
VALUES
    ('d7d5866c-969c-11ee-b9d1-0242ac120002', 'Alice', 'Savings', 'Savings', 'ACTIVE', 5000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'b3a3a896-969c-11ee-b9d1-0242ac120002'),
    ('06c8dc62-969d-11ee-b9d1-0242ac120002', 'Bob', 'Checking', 'Checking', 'ACTIVE', 2000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'b9814aa2-969c-11ee-b9d1-0242ac120002');
...
VALUES ('a80e7834-969d-11ee-b9d1-0242ac120002', 'DEPOSIT', 1000, 'Initial deposit',
        'd7d5866c-969c-11ee-b9d1-0242ac120002', NULL),
       ('ad05644c-969d-11ee-b9d1-0242ac120002', 'PURCHASE', 50, 'Groceries',
        '06c8dc62-969d-11ee-b9d1-0242ac120002', NULL),
