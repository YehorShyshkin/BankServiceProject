...
public class Account {
     ...
     *
     * ----- English -------
     * The status of the account, which may indicate its state,
     * such as "active," "closed," etc.
     */
    @Column(name = "status")
    @Enumerated(EnumType.STRING)
     ...
     *
     * ----- English -------
     * The currency code in which funds in the account are tracked,
     * e.g., "USD" or "EUR."
     */
     ...
     *
     * ----- English -------
     * Financial operation where funds are transferred
     * to the client's bank account or credit/debit card.
     */
     ...
     *
     * ----- English -------
     * Represents a class with various properties
     * representing information about a bank card.
     */
